...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,3),I=0,6) /11, 1,-1,-1,-1,-1,-1/
      DATA (NHEL(I,4),I=0,6) /13, 1,-1,-1, 1, 1,-1/
      DATA (NHEL(I,5),I=0,6) /15, 1,-1,-1, 1,-1,-1/
      DATA (NHEL(I,6),I=0,6) /17, 1, 1, 1,-1, 1,-1/
      DATA (NHEL(I,7),I=0,6) /19, 1, 1, 1,-1,-1,-1/
      DATA (NHEL(I,8),I=0,6) /21, 1, 1, 1, 1, 1,-1/
      DATA (NHEL(I,9),I=0,6) /23, 1, 1, 1, 1,-1,-1/
      DATA (NHEL(I,10),I=0,6) /25, 1, 1,-1,-1, 1,-1/
      DATA (NHEL(I,11),I=0,6) /29, 1, 1,-1, 1, 1,-1/
      DATA (NHEL(I,12),I=0,6) /33,-1,-1, 1,-1, 1,-1/
      DATA (NHEL(I,13),I=0,6) /37,-1,-1, 1, 1, 1,-1/
      DATA (NHEL(I,14),I=0,6) /41,-1,-1,-1,-1, 1,-1/
      DATA (NHEL(I,15),I=0,6) /43,-1,-1,-1,-1,-1,-1/
      DATA (NHEL(I,16),I=0,6) /45,-1,-1,-1, 1, 1,-1/
      DATA (NHEL(I,17),I=0,6) /47,-1,-1,-1, 1,-1,-1/
      DATA (NHEL(I,18),I=0,6) /49,-1, 1, 1,-1, 1,-1/
      DATA (NHEL(I,19),I=0,6) /51,-1, 1, 1,-1,-1,-1/
      DATA (NHEL(I,20),I=0,6) /53,-1, 1, 1, 1, 1,-1/
      DATA (NHEL(I,21),I=0,6) /55,-1, 1, 1, 1,-1,-1/
      DATA (NHEL(I,22),I=0,6) /57,-1, 1,-1,-1, 1,-1/
      DATA IDEN/12/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MU,+1,+1*IC(1),W(1,1))  !  count 12
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 12
      CALL OXXXXX(P(0,2),MDL_MMU,+1,-1*IC(2),W(1,3))  !  count 33
      CALL OXXXXX(P(0,2),MDL_MMU,-1,-1*IC(2),W(1,4))  !  count 33
      CALL IXXXXX(P(0,3),MDL_MMU,+1,-1*IC(3),W(1,5))  !  count 33
      CALL IXXXXX(P(0,3),MDL_MMU,-1,-1*IC(3),W(1,6))  !  count 33
      CALL OXXXXX(P(0,4),MDL_MB,+1,+1*IC(4),W(1,7))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MB,-1,+1*IC(4),W(1,8))  !  count 2
      CALL IXXXXX(P(0,5),MDL_MMU,+1,-1*IC(5),W(1,9))  !  count 1
      CALL IXXXXX(P(0,5),MDL_MMU,-1,-1*IC(5),W(1,10))  !  count 1
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,11))  !  count 2
      CALL FFV2_3(W(1,9),W(1,11),GC_52,MDL_MW,FK_MDL_WW,W(1,12))  !  count 2
      CALL FFV2_3(W(1,10),W(1,11),GC_52,MDL_MW,FK_MDL_WW,W(1,13))  !  count 2
      CALL FFV2_1(W(1,7),W(1,12),GC_92,MDL_MT,FK_MDL_WT,W(1,14))  !  count 6
      CALL FFV2_1(W(1,7),W(1,13),GC_92,MDL_MT,FK_MDL_WT,W(1,15))  !  count 6
      CALL FFV2_1(W(1,8),W(1,12),GC_92,MDL_MT,FK_MDL_WT,W(1,16))  !  count 6
      CALL FFV2_1(W(1,8),W(1,13),GC_92,MDL_MT,FK_MDL_WT,W(1,17))  !  count 6
      CALL FFS1_2_3(W(1,1),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,18))  !  count 3
      CALL FFS1_2_3(W(1,1),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,19))  !  count 2
      CALL FFS1_2_3(W(1,1),W(1,16),GC_16,GC_12,MDL_MH,ZERO,W(1,20))  !  count 4
      CALL FFS1_2_3(W(1,1),W(1,17),GC_16,GC_12,MDL_MH,ZERO,W(1,21))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,22))  !  count 3
      CALL FFS1_2_3(W(1,2),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,23))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,16),GC_16,GC_12,MDL_MH,ZERO,W(1,24))  !  count 4
      CALL FFS1_2_3(W(1,2),W(1,17),GC_16,GC_12,MDL_MH,ZERO,W(1,25))  !  count 2
      CALL FFS3P1N_3(W(1,5), W(1,3), GC_79, TMP(1))
      call CombineAmpS(8,
     & (/8,9,6,7,20,21,18,19/), 
     & (/18,19,20,21,22,23,24,25/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,5), W(1,4), GC_79, TMP(1))
      call CombineAmpS(3,
     & (/1,13,12/), 
     & (/20,22,24/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,6), W(1,3), GC_79, TMP(1))
      call CombineAmpS(3,
     & (/11,10,22/), 
     & (/18,20,24/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,6), W(1,4), GC_79, TMP(1))
      call CombineAmpS(8,
     & (/4,5,2,3,16,17,14,15/), 
     & (/18,19,20,21,22,23,24,25/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3_5_9_3(W(1,1),W(1,14),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,26))  !  count 3
      CALL FFV2_3_5_9_3(W(1,1),W(1,15),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,27))  !  count 2
      CALL FFV2_3_5_9_3(W(1,1),W(1,16),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,28))  !  count 4
      CALL FFV2_3_5_9_3(W(1,1),W(1,17),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,29))  !  count 2
      CALL FFV2_3_5_9_3(W(1,2),W(1,14),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,30))  !  count 3
      CALL FFV2_3_5_9_3(W(1,2),W(1,15),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,31))  !  count 2
      CALL FFV2_3_5_9_3(W(1,2),W(1,16),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,32))  !  count 4
      CALL FFV2_3_5_9_3(W(1,2),W(1,17),GC_43,GC_40,GC_47,GC_36,MDL_MZ,ZE
     $RO,W(1,33))  !  count 2
      CALL FFV2_7P1N_3(W(1,5), W(1,3), GC_62, GC_69, TMP(1))
      call CombineAmp(8,
     & (/8,9,6,7,20,21,18,19/), 
     & (/26,27,28,29,30,31,32,33/),
     & TMP, W, AMP(1,2))
      CALL FFV2_7P1N_3(W(1,5), W(1,4), GC_62, GC_69, TMP(1))
      call CombineAmp(3,
     & (/1,13,12/), 
     & (/28,30,32/),
     & TMP, W, AMP(1,2))
      CALL FFV2_7P1N_3(W(1,6), W(1,3), GC_62, GC_69, TMP(1))
      call CombineAmp(3,
     & (/11,10,22/), 
     & (/26,28,32/),
     & TMP, W, AMP(1,2))
      CALL FFV2_7P1N_3(W(1,6), W(1,4), GC_62, GC_69, TMP(1))
      call CombineAmp(8,
     & (/4,5,2,3,16,17,14,15/), 
     & (/26,27,28,29,30,31,32,33/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV3_9P0_3(W(1,1),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,34))  !  count 3
      CALL FFV3_9P0_3(W(1,1),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,35))  !  count 2
      CALL FFV3_9P0_3(W(1,1),W(1,16),GC_25,GC_21,ZERO,FK_ZERO,W(1,36))  !  count 4
      CALL FFV3_9P0_3(W(1,1),W(1,17),GC_25,GC_21,ZERO,FK_ZERO,W(1,37))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,38))  !  count 3
      CALL FFV3_9P0_3(W(1,2),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,16),GC_25,GC_21,ZERO,FK_ZERO,W(1,40))  !  count 4
      CALL FFV3_9P0_3(W(1,2),W(1,17),GC_25,GC_21,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL FFV1P1N_3(W(1,5), W(1,3), GC_3, TMP(1))
      call CombineAmp(8,
     & (/8,9,6,7,20,21,18,19/), 
     & (/34,35,36,37,38,39,40,41/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_3(W(1,5), W(1,4), GC_3, TMP(1))
      call CombineAmp(3,
     & (/1,13,12/), 
     & (/36,38,40/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_3(W(1,6), W(1,3), GC_3, TMP(1))
      call CombineAmp(3,
     & (/11,10,22/), 
     & (/34,36,40/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_3(W(1,6), W(1,4), GC_3, TMP(1))
      call CombineAmp(8,
     & (/4,5,2,3,16,17,14,15/), 
     & (/34,35,36,37,38,39,40,41/),
