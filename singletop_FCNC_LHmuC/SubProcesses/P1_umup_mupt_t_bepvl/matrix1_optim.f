...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,9),I=0,6) /29, 1, 1,-1, 1, 1,-1/
      DATA (NHEL(I,10),I=0,6) /33,-1,-1, 1,-1, 1,-1/
      DATA (NHEL(I,11),I=0,6) /41,-1,-1,-1,-1, 1,-1/
      DATA (NHEL(I,12),I=0,6) /45,-1,-1,-1, 1, 1,-1/
      DATA (NHEL(I,13),I=0,6) /49,-1, 1, 1,-1, 1,-1/
      DATA (NHEL(I,14),I=0,6) /53,-1, 1, 1, 1, 1,-1/
      DATA (NHEL(I,15),I=0,6) /57,-1, 1,-1,-1, 1,-1/
      DATA IDEN/12/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MU,+1,+1*IC(1),W(1,1))  !  count 9
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MMU,+1,-1*IC(2),W(1,3))  !  count 24
      CALL OXXXXX(P(0,2),MDL_MMU,-1,-1*IC(2),W(1,4))  !  count 21
      CALL IXXXXX(P(0,3),MDL_MMU,+1,-1*IC(3),W(1,5))  !  count 21
      CALL IXXXXX(P(0,3),MDL_MMU,-1,-1*IC(3),W(1,6))  !  count 24
      CALL OXXXXX(P(0,4),MDL_MB,+1,+1*IC(4),W(1,7))  !  count 1
      CALL OXXXXX(P(0,4),MDL_MB,-1,+1*IC(4),W(1,8))  !  count 2
      CALL IXXXXX(P(0,5),MDL_ME,+1,-1*IC(5),W(1,9))  !  count 1
      CALL IXXXXX(P(0,5),MDL_ME,-1,-1*IC(5),W(1,10))  !  count 1
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,11))  !  count 2
      CALL FFV2_3(W(1,9),W(1,11),GC_52,MDL_MW,FK_MDL_WW,W(1,12))  !  count 2
      CALL FFV2_3(W(1,10),W(1,11),GC_52,MDL_MW,FK_MDL_WW,W(1,13))  !  count 1
      CALL FFV2_1(W(1,7),W(1,12),GC_92,MDL_MT,FK_MDL_WT,W(1,14))  !  count 6
      CALL FFV2_1(W(1,8),W(1,12),GC_92,MDL_MT,FK_MDL_WT,W(1,15))  !  count 6
      CALL FFV2_1(W(1,8),W(1,13),GC_92,MDL_MT,FK_MDL_WT,W(1,16))  !  count 3
      CALL FFS1_2_3(W(1,1),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,17))  !  count 3
      CALL FFS1_2_3(W(1,1),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,18))  !  count 4
      CALL FFS1_2_3(W(1,1),W(1,16),GC_16,GC_12,MDL_MH,ZERO,W(1,19))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,20))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,21))  !  count 4
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV3_9P0_3(W(1,1),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,27))  !  count 3
      CALL FFV3_9P0_3(W(1,1),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,28))  !  count 4
      CALL FFV3_9P0_3(W(1,1),W(1,16),GC_25,GC_21,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,30))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,31))  !  count 4
