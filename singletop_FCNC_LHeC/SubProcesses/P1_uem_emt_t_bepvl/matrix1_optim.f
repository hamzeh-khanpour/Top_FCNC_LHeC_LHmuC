...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,3))  !  count 18
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,4))  !  count 12
      CALL OXXXXX(P(0,3),MDL_ME,+1,+1*IC(3),W(1,5))  !  count 15
      CALL OXXXXX(P(0,3),MDL_ME,-1,+1*IC(3),W(1,6))  !  count 15
      ...
      CALL FFS1_2_3(W(1,1),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,17))  !  count 2
      CALL FFS1_2_3(W(1,1),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,18))  !  count 3
      CALL FFS1_2_3(W(1,1),W(1,16),GC_16,GC_12,MDL_MH,ZERO,W(1,19))  !  count 1
      CALL FFS1_2_3(W(1,2),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,20))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,21))  !  count 2
      CALL FFS3P1N_3(W(1,3), W(1,5), GC_78, TMP(1))
      call CombineAmpS(5,
     & (/4,2,3,8,7/), 
     & (/17,18,19,20,21/),
     & TMP, W, AMP(1,1))
      CALL FFS3_0(W(1,3),W(1,6),W(1,18),GC_78,AMP(1,1))
     ...
     & (/22,23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV2_7_0(W(1,3),W(1,6),W(1,23),GC_62,GC_69,AMP(1,2))
      CALL FFV2_7P1N_3(W(1,4), W(1,6), GC_62, GC_69, TMP(1))
      call CombineAmp(4,
     & (/6,5,10,9/), 
     & (/22,23,25,26/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV3_9P0_3(W(1,1),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,27))  !  count 2
      CALL FFV3_9P0_3(W(1,1),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,28))  !  count 3
      CALL FFV3_9P0_3(W(1,1),W(1,16),GC_25,GC_21,ZERO,FK_ZERO,W(1,29))  !  count 1
      CALL FFV3_9P0_3(W(1,2),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,30))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,31))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,5), GC_3, TMP(1))
      call CombineAmp(5,
     & (/4,2,3,8,7/), 
     & (/27,28,29,30,31/),
     & TMP, W, AMP(1,3))
      CALL FFV1_0(W(1,3),W(1,6),W(1,28),GC_3,AMP(1,3))
