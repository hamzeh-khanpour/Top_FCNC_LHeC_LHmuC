...
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,2),W(1,3),W(1,7),GC_78,AMP(1))
      CALL FFV2_3_5_9_3(W(1,1),W(1,6),GC_41,GC_38,GC_45,GC_34,MDL_MZ,
     $  ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV2_7_0(W(1,2),W(1,3),W(1,7),GC_62,GC_69,AMP(2))
      CALL FFV3_9P0_3(W(1,1),W(1,6),GC_23,GC_19,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,2),W(1,3),W(1,7),GC_3,AMP(3))
