...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,11),I=0,6) /43,-1, 1, 1,-1,-1,-1/
      DATA (NHEL(I,12),I=0,6) /45,-1, 1, 1, 1, 1,-1/
      DATA (NHEL(I,13),I=0,6) /47,-1, 1, 1, 1,-1,-1/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,3))  !  count 27
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,4))  !  count 24
      CALL OXXXXX(P(0,3),MDL_ME,+1,+1*IC(3),W(1,5))  !  count 24
      CALL OXXXXX(P(0,3),MDL_ME,-1,+1*IC(3),W(1,6))  !  count 27
      ...
      CALL FFS1_2_3(W(1,1),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,18))  !  count 2
      CALL FFS1_2_3(W(1,1),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,19))  !  count 2
      CALL FFS1_2_3(W(1,1),W(1,16),GC_16,GC_12,MDL_MH,ZERO,W(1,20))  !  count 3
      CALL FFS1_2_3(W(1,1),W(1,17),GC_16,GC_12,MDL_MH,ZERO,W(1,21))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,14),GC_16,GC_12,MDL_MH,ZERO,W(1,22))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,15),GC_16,GC_12,MDL_MH,ZERO,W(1,23))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,16),GC_16,GC_12,MDL_MH,ZERO,W(1,24))  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,17),GC_16,GC_12,MDL_MH,ZERO,W(1,25))  !  count 2
      CALL FFS3P1N_3(W(1,3), W(1,5), GC_78, TMP(1))
      call CombineAmpS(8,
     & (/4,5,2,3,12,13,10,11/), 
     & (/18,19,20,21,22,23,24,25/),
     & TMP, W, AMP(1,1))
      CALL FFS3_0(W(1,3),W(1,6),W(1,20),GC_78,AMP(1,1))
      CALL FFS3P1N_3(W(1,4), W(1,6), GC_78, TMP(1))
      call CombineAmpS(8,
     & (/8,9,6,7,16,17,14,15/), 
     & (/18,19,20,21,22,23,24,25/),
     ...
     $RO,W(1,33))  !  count 2
      CALL FFV2_7P1N_3(W(1,3), W(1,5), GC_62, GC_69, TMP(1))
      call CombineAmp(8,
     & (/4,5,2,3,12,13,10,11/), 
     & (/26,27,28,29,30,31,32,33/),
     & TMP, W, AMP(1,2))
      CALL FFV2_7_0(W(1,3),W(1,6),W(1,28),GC_62,GC_69,AMP(1,2))
      CALL FFV2_7P1N_3(W(1,4), W(1,6), GC_62, GC_69, TMP(1))
      call CombineAmp(8,
     & (/8,9,6,7,16,17,14,15/), 
     & (/26,27,28,29,30,31,32,33/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV3_9P0_3(W(1,1),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,34))  !  count 2
      CALL FFV3_9P0_3(W(1,1),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,35))  !  count 2
      CALL FFV3_9P0_3(W(1,1),W(1,16),GC_25,GC_21,ZERO,FK_ZERO,W(1,36))  !  count 3
      CALL FFV3_9P0_3(W(1,1),W(1,17),GC_25,GC_21,ZERO,FK_ZERO,W(1,37))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,14),GC_25,GC_21,ZERO,FK_ZERO,W(1,38))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,15),GC_25,GC_21,ZERO,FK_ZERO,W(1,39))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,16),GC_25,GC_21,ZERO,FK_ZERO,W(1,40))  !  count 2
      CALL FFV3_9P0_3(W(1,2),W(1,17),GC_25,GC_21,ZERO,FK_ZERO,W(1,41))  !  count 2
      CALL FFV1P1N_3(W(1,3), W(1,5), GC_3, TMP(1))
      call CombineAmp(8,
     & (/4,5,2,3,12,13,10,11/), 
     & (/34,35,36,37,38,39,40,41/),
     & TMP, W, AMP(1,3))
      CALL FFV1_0(W(1,3),W(1,6),W(1,36),GC_3,AMP(1,3))
      CALL FFV1P1N_3(W(1,4), W(1,6), GC_3, TMP(1))
      call CombineAmp(8,
     & (/8,9,6,7,16,17,14,15/), 
     & (/34,35,36,37,38,39,40,41/),
