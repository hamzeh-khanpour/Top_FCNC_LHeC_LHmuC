...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,4),W(1,5),GC_52,MDL_MW, FK_MDL_WW,W(1,6))
      CALL OXXXXX(P(0,6),MDL_MS,NHEL(6),+1*IC(6),W(1,5))
      CALL FFV2_2(W(1,1),W(1,6),GC_85,MDL_MS, FK_ZERO,W(1,4))
      CALL FFS3_3(W(1,3),W(1,2),GC_79,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,4),W(1,5),W(1,7),GC_80,AMP(1))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,5),W(1,8),GC_1,AMP(2))
      CALL FFV2_7_3(W(1,3),W(1,2),GC_62,GC_69,MDL_MZ, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_6_0(W(1,4),W(1,5),W(1,9),GC_62,GC_68,AMP(3))
      CALL FFV2_3(W(1,1),W(1,5),GC_85,MDL_MW, ZERO,W(1,4))
C     Amplitude(s) for diagram number 4
      CALL VVS1_0(W(1,4),W(1,6),W(1,7),GC_73,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,8),W(1,4),W(1,6),GC_4,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVV1_0(W(1,4),W(1,6),W(1,9),GC_64,AMP(6))
      CALL FFV2_1(W(1,2),W(1,6),GC_52,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,3),W(1,10),W(1,4),GC_52,AMP(7))
      CALL FFV2_1(W(1,5),W(1,6),GC_85,MDL_MU, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL FFS3_0(W(1,1),W(1,10),W(1,7),GC_83,AMP(8))
      CALL FFV2_1(W(1,5),W(1,6),GC_91,MDL_MT, FK_MDL_WT,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFS1_2_0(W(1,1),W(1,4),W(1,7),GC_16,GC_12,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,1),W(1,10),W(1,8),GC_2,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_8_0(W(1,1),W(1,10),W(1,9),GC_63,GC_68,AMP(11))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $   +AMP(6))
        ...
        AMP2(8)=AMP2(8)+(AMP(8)+AMP(10)+AMP(11))*DCONJG(AMP(8)+AMP(10)
     $   +AMP(11))
