...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,4),I=0,6) /25, 1, 1,-1, 1,-1,-1/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 27
      CALL OXXXXX(P(0,2),MDL_MMU,+1,-1*IC(2),W(1,3))  !  count 7
      ...
      CALL FFV2_3(W(1,7),W(1,8),GC_52,MDL_MW,FK_MDL_WW,W(1,9))  !  count 38
      CALL OXXXXX(P(0,6),MDL_MD,+1,+1*IC(6),W(1,10))  !  count 9
      CALL OXXXXX(P(0,6),MDL_MD,-1,+1*IC(6),W(1,11))  !  count 28
      CALL FFV2_2(W(1,1),W(1,9),GC_87,MDL_MD,FK_ZERO,W(1,12))  !  count 12
      CALL FFV2_2(W(1,2),W(1,9),GC_87,MDL_MD,FK_ZERO,W(1,13))  !  count 18
      CALL FFS3_3(W(1,5),W(1,3),GC_79,MDL_MH,ZERO,W(1,14))  !  count 12
      CALL FFS3_3(W(1,5),W(1,4),GC_79,MDL_MH,ZERO,W(1,15))  !  count 8
      CALL FFS3_3(W(1,6),W(1,3),GC_79,MDL_MH,ZERO,W(1,16))  !  count 8
      CALL FFS3_3(W(1,6),W(1,4),GC_79,MDL_MH,ZERO,W(1,17))  !  count 12
      CALL FFS3P1N_3(W(1,12), W(1,11), GC_77, TMP(1))
      call CombineAmpS(4,
     & (/3,1,4,2/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,13), W(1,11), GC_77, TMP(1))
      call CombineAmpS(4,
     & (/8,5,10,6/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,13), W(1,10), GC_77, TMP(1))
      call CombineAmpS(2,
     & (/9,7/), 
     & (/14,17/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,5),W(1,3),GC_3,ZERO,FK_ZERO,W(1,18))  !  count 9
      CALL FFV1P0_3(W(1,5),W(1,4),GC_3,ZERO,FK_ZERO,W(1,19))  !  count 6
      CALL FFV1P0_3(W(1,6),W(1,3),GC_3,ZERO,FK_ZERO,W(1,20))  !  count 6
      CALL FFV1P0_3(W(1,6),W(1,4),GC_3,ZERO,FK_ZERO,W(1,21))  !  count 9
      CALL FFV1P1N_3(W(1,12), W(1,11), GC_1, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_3(W(1,13), W(1,11), GC_1, TMP(1))
      call CombineAmp(4,
     & (/8,5,10,6/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_3(W(1,13), W(1,10), GC_1, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/18,21/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_7_3(W(1,5),W(1,3),GC_62,GC_69,MDL_MZ,ZERO,W(1,22))  !  count 9
      CALL FFV2_7_3(W(1,5),W(1,4),GC_62,GC_69,MDL_MZ,ZERO,W(1,23))  !  count 6
      CALL FFV2_7_3(W(1,6),W(1,3),GC_62,GC_69,MDL_MZ,ZERO,W(1,24))  !  count 6
      CALL FFV2_7_3(W(1,6),W(1,4),GC_62,GC_69,MDL_MZ,ZERO,W(1,25))  !  count 9
      CALL FFV2_6P1N_3(W(1,12), W(1,11), GC_62, GC_68, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,3))
      CALL FFV2_6P1N_3(W(1,13), W(1,11), GC_62, GC_68, TMP(1))
      call CombineAmp(4,
     & (/8,5,10,6/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,3))
      CALL FFV2_6P1N_3(W(1,13), W(1,10), GC_62, GC_68, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/22,25/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3(W(1,1),W(1,11),GC_87,MDL_MW,ZERO,W(1,26))  !  count 16
      CALL FFV2_3(W(1,2),W(1,10),GC_87,MDL_MW,ZERO,W(1,27))  !  count 8
      CALL FFV2_3(W(1,2),W(1,11),GC_87,MDL_MW,ZERO,W(1,28))  !  count 16
      CALL VVS1P1N_3(W(1,26), W(1,9), GC_73, TMP(1))
      call CombineAmpS(4,
     & (/3,1,4,2/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_3(W(1,27), W(1,9), GC_73, TMP(1))
      call CombineAmpS(2,
     & (/9,7/), 
     & (/14,17/),
     & TMP, W, AMP(1,4))
      CALL VVS1P1N_3(W(1,28), W(1,9), GC_73, TMP(1))
      call CombineAmpS(4,
     & (/8,5,10,6/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL VVV1P1N_1(W(1,26), W(1,9), GC_4, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,5))
      CALL VVV1P1N_1(W(1,27), W(1,9), GC_4, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/18,21/),
     & TMP, W, AMP(1,5))
      CALL VVV1P1N_1(W(1,28), W(1,9), GC_4, TMP(1))
      call CombineAmp(4,
     & (/8,5,10,6/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL VVV1P1N_3(W(1,26), W(1,9), GC_64, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,6))
      CALL VVV1P1N_3(W(1,27), W(1,9), GC_64, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/22,25/),
     & TMP, W, AMP(1,6))
      CALL VVV1P1N_3(W(1,28), W(1,9), GC_64, TMP(1))
      call CombineAmp(4,
     & (/8,5,10,6/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV2_1(W(1,3),W(1,9),GC_52,ZERO,FK_ZERO,W(1,29))  !  count 5
      CALL FFV2_1(W(1,4),W(1,9),GC_52,ZERO,FK_ZERO,W(1,30))  !  count 5
      CALL FFV2P1N_3(W(1,5), W(1,29), GC_52, TMP(1))
      call CombineAmp(3,
     & (/3,9,8/), 
     & (/26,27,28/),
     & TMP, W, AMP(1,7))
      CALL FFV2P1N_3(W(1,5), W(1,30), GC_52, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/26,28/),
     & TMP, W, AMP(1,7))
      CALL FFV2P1N_3(W(1,6), W(1,29), GC_52, TMP(1))
      call CombineAmp(2,
     & (/4,10/), 
     & (/26,28/),
     & TMP, W, AMP(1,7))
      CALL FFV2P1N_3(W(1,6), W(1,30), GC_52, TMP(1))
      call CombineAmp(3,
     & (/2,7,6/), 
     & (/26,27,28/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV2_1(W(1,10),W(1,9),GC_87,MDL_MC,FK_ZERO,W(1,31))  !  count 6
      CALL FFV2_1(W(1,11),W(1,9),GC_87,MDL_MC,FK_ZERO,W(1,32))  !  count 24
      CALL FFS3P1N_3(W(1,1), W(1,32), GC_76, TMP(1))
      call CombineAmpS(4,
     & (/3,1,4,2/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,8))
      CALL FFS3P1N_3(W(1,2), W(1,32), GC_76, TMP(1))
      call CombineAmpS(4,
     & (/8,5,10,6/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,8))
      CALL FFS3P1N_3(W(1,2), W(1,31), GC_76, TMP(1))
      call CombineAmpS(2,
     & (/9,7/), 
     & (/14,17/),
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV2_1(W(1,10),W(1,9),GC_90,MDL_MT,FK_MDL_WT,W(1,33))  !  count 2
      CALL FFV2_1(W(1,11),W(1,9),GC_90,MDL_MT,FK_MDL_WT,W(1,34))  !  count 8
      CALL FFS1_2P1N_3(W(1,1), W(1,34), GC_14, GC_10, TMP(1))
      call CombineAmpS(4,
     & (/3,1,4,2/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,9))
      CALL FFS1_2P1N_3(W(1,2), W(1,34), GC_14, GC_10, TMP(1))
      call CombineAmpS(4,
     & (/8,5,10,6/), 
     & (/14,15,16,17/),
     & TMP, W, AMP(1,9))
      CALL FFS1_2P1N_3(W(1,2), W(1,33), GC_14, GC_10, TMP(1))
      call CombineAmpS(2,
     & (/9,7/), 
     & (/14,17/),
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV1P1N_3(W(1,1), W(1,32), GC_2, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,10))
      CALL FFV1P1N_3(W(1,2), W(1,32), GC_2, TMP(1))
      call CombineAmp(4,
     & (/8,5,10,6/), 
     & (/18,19,20,21/),
     & TMP, W, AMP(1,10))
      CALL FFV1P1N_3(W(1,2), W(1,31), GC_2, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/18,21/),
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV2_8P1N_3(W(1,1), W(1,32), GC_63, GC_68, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,11))
      CALL FFV2_8P1N_3(W(1,2), W(1,32), GC_63, GC_68, TMP(1))
      call CombineAmp(4,
     & (/8,5,10,6/), 
     & (/22,23,24,25/),
     & TMP, W, AMP(1,11))
      CALL FFV2_8P1N_3(W(1,2), W(1,31), GC_63, GC_68, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/22,25/),
