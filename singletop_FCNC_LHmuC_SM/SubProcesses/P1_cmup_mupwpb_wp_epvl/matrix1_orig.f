...
C     
C     Process: c mu+ > mu+ w+ b WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_2(W(1,1),W(1,6),GC_89,MDL_MB, FK_ZERO,W(1,4))
      CALL FFS3_3(W(1,3),W(1,2),GC_79,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,4),W(1,5),W(1,7),GC_75,AMP(1))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_89,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_1(W(1,5),W(1,6),GC_89,MDL_MC, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL FFS3_0(W(1,1),W(1,10),W(1,7),GC_76,AMP(8))
      CALL FFV2_1(W(1,5),W(1,6),GC_92,MDL_MT, FK_MDL_WT,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFS1_2_0(W(1,1),W(1,4),W(1,7),GC_14,GC_10,AMP(9))
