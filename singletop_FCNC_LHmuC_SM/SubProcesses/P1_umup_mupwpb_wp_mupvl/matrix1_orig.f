...
C     
C     Process: u mu+ > mu+ w+ b WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_2(W(1,1),W(1,6),GC_86,MDL_MB, FK_ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_86,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_1(W(1,5),W(1,6),GC_86,MDL_MU, FK_ZERO,W(1,10))
