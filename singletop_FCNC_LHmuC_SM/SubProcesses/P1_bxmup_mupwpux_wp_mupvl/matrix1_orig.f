...
C     
C     Process: b~ mu+ > mu+ w+ u~ WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_2(W(1,5),W(1,6),GC_86,MDL_MB, FK_ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3(W(1,5),W(1,1),GC_86,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_1(W(1,1),W(1,6),GC_86,MDL_MU, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL FFS3_0(W(1,5),W(1,10),W(1,7),GC_83,AMP(8))
      CALL FFV2_1(W(1,1),W(1,6),GC_92,MDL_MT, ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFS1_2_0(W(1,5),W(1,4),W(1,7),GC_16,GC_12,AMP(9))
