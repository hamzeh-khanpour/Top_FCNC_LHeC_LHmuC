...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_2(W(1,5),W(1,6),GC_84,MDL_MD, FK_ZERO,W(1,4))
      CALL FFS3_3(W(1,3),W(1,2),GC_79,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,4),W(1,1),W(1,7),GC_77,AMP(1))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3(W(1,5),W(1,1),GC_84,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_1(W(1,1),W(1,6),GC_84,MDL_MU, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 8
      CALL FFS3_0(W(1,5),W(1,10),W(1,7),GC_83,AMP(8))
      CALL FFV2_1(W(1,1),W(1,6),GC_90,MDL_MT, ZERO,W(1,4))
