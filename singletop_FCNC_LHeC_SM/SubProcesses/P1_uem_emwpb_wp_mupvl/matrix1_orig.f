...
C     
C     Process: u e- > e- w+ b WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFS3_3(W(1,2),W(1,3),GC_78,MDL_MH, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS3_0(W(1,4),W(1,5),W(1,7),GC_75,AMP(1))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_3,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,5),W(1,8),GC_1,AMP(2))
      CALL FFV2_7_3(W(1,2),W(1,3),GC_62,GC_69,MDL_MZ, ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_1(W(1,3),W(1,6),GC_52,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,2),W(1,10),W(1,4),GC_52,AMP(7))
