...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WZ) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_MS,+1,-1*IC(1),W(1,1))  !  count 19
      ...
      CALL OXXXXX(P(0,3),MDL_ME,-1,+1*IC(3),W(1,6))  !  count 4
      CALL IXXXXX(P(0,4),MDL_ME,+1,-1*IC(4),W(1,7))  !  count 1
      CALL OXXXXX(P(0,5),ZERO,-1,+1*IC(5),W(1,8))  !  count 1
      CALL FFV2_3(W(1,7),W(1,8),GC_52,MDL_MW,FK_MDL_WW,W(1,9))  !  count 35
      CALL IXXXXX(P(0,6),MDL_MC,+1,-1*IC(6),W(1,10))  !  count 23
      CALL IXXXXX(P(0,6),MDL_MC,-1,-1*IC(6),W(1,11))  !  count 19
      CALL FFV2_2(W(1,10),W(1,9),GC_88,MDL_MS,FK_ZERO,W(1,12))  !  count 15
      CALL FFV2_2(W(1,11),W(1,9),GC_88,MDL_MS,FK_ZERO,W(1,13))  !  count 12
      CALL FFS3_3(W(1,3),W(1,5),GC_78,MDL_MH,ZERO,W(1,14))  !  count 16
      CALL FFS3_3(W(1,4),W(1,5),GC_78,MDL_MH,ZERO,W(1,15))  !  count 4
      CALL FFS3_3(W(1,4),W(1,6),GC_78,MDL_MH,ZERO,W(1,16))  !  count 16
      CALL FFS3P1N_3(W(1,12), W(1,1), GC_80, TMP(1))
      call CombineAmpS(3,
     & (/5,9,7/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,12), W(1,2), GC_80, TMP(1))
      call CombineAmpS(2,
     & (/1,3/), 
     & (/14,16/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,13), W(1,1), GC_80, TMP(1))
      call CombineAmpS(2,
     & (/6,8/), 
     & (/14,16/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_3(W(1,13), W(1,2), GC_80, TMP(1))
      call CombineAmpS(2,
     & (/2,4/), 
     & (/14,16/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,3),W(1,5),GC_3,ZERO,FK_ZERO,W(1,17))  !  count 12
      CALL FFV1P0_3(W(1,4),W(1,5),GC_3,ZERO,FK_ZERO,W(1,18))  !  count 3
      CALL FFV1P0_3(W(1,4),W(1,6),GC_3,ZERO,FK_ZERO,W(1,19))  !  count 12
      CALL FFV1P1N_3(W(1,12), W(1,1), GC_1, TMP(1))
      call CombineAmp(3,
     & (/5,9,7/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_3(W(1,12), W(1,2), GC_1, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/17,19/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_3(W(1,13), W(1,1), GC_1, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/17,19/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_3(W(1,13), W(1,2), GC_1, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/17,19/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_7_3(W(1,3),W(1,5),GC_62,GC_69,MDL_MZ,ZERO,W(1,20))  !  count 12
      CALL FFV2_7_3(W(1,4),W(1,5),GC_62,GC_69,MDL_MZ,ZERO,W(1,21))  !  count 3
      CALL FFV2_7_3(W(1,4),W(1,6),GC_62,GC_69,MDL_MZ,ZERO,W(1,22))  !  count 12
      CALL FFV2_6P1N_3(W(1,12), W(1,1), GC_62, GC_68, TMP(1))
      call CombineAmp(3,
     & (/5,9,7/), 
     & (/20,21,22/),
     & TMP, W, AMP(1,3))
      CALL FFV2_6P1N_3(W(1,12), W(1,2), GC_62, GC_68, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/20,22/),
     & TMP, W, AMP(1,3))
      CALL FFV2_6P1N_3(W(1,13), W(1,1), GC_62, GC_68, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/20,22/),
     & TMP, W, AMP(1,3))
      CALL FFV2_6P1N_3(W(1,13), W(1,2), GC_62, GC_68, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/20,22/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3(W(1,10),W(1,1),GC_88,MDL_MW,ZERO,W(1,23))  !  count 12
      CALL FFV2_3(W(1,10),W(1,2),GC_88,MDL_MW,ZERO,W(1,24))  !  count 8
      CALL FFV2_3(W(1,11),W(1,1),GC_88,MDL_MW,ZERO,W(1,25))  !  count 8
      CALL FFV2_3(W(1,11),W(1,2),GC_88,MDL_MW,ZERO,W(1,26))  !  count 8
      CALL VVS1P1N_1(W(1,9), W(1,14), GC_73, TMP(1))
      call CombineAmp(4,
     & (/5,1,6,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,4))
      CALL VVS1_0(W(1,23),W(1,9),W(1,15),GC_73,AMP(9,4))
      CALL VVS1P1N_1(W(1,9), W(1,16), GC_73, TMP(1))
      call CombineAmp(4,
     & (/7,3,8,4/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL VVV1P1N_2(W(1,17), W(1,9), GC_4, TMP(1))
      call CombineAmp(4,
     & (/5,1,6,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))
      CALL VVV1_0(W(1,18),W(1,23),W(1,9),GC_4,AMP(9,5))
      CALL VVV1P1N_2(W(1,19), W(1,9), GC_4, TMP(1))
      call CombineAmp(4,
     & (/7,3,8,4/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL VVV1P1N_1(W(1,9), W(1,20), GC_64, TMP(1))
      call CombineAmp(4,
     & (/5,1,6,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,6))
      CALL VVV1_0(W(1,23),W(1,9),W(1,21),GC_64,AMP(9,6))
      CALL VVV1P1N_1(W(1,9), W(1,22), GC_64, TMP(1))
      call CombineAmp(4,
     & (/7,3,8,4/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV2_1(W(1,5),W(1,9),GC_52,ZERO,FK_ZERO,W(1,27))  !  count 5
      CALL FFV2_1(W(1,6),W(1,9),GC_52,ZERO,FK_ZERO,W(1,28))  !  count 4
      CALL FFV2P1N_3(W(1,3), W(1,27), GC_52, TMP(1))
      call CombineAmp(4,
     & (/5,1,6,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,7))
      CALL FFV2_0(W(1,4),W(1,27),W(1,23),GC_52,AMP(9,7))
      CALL FFV2P1N_3(W(1,4), W(1,28), GC_52, TMP(1))
      call CombineAmp(4,
     & (/7,3,8,4/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV2_1(W(1,1),W(1,9),GC_88,MDL_MC,FK_ZERO,W(1,29))  !  count 15
      CALL FFV2_1(W(1,2),W(1,9),GC_88,MDL_MC,FK_ZERO,W(1,30))  !  count 12
      CALL FFS3P1N_3(W(1,10), W(1,29), GC_76, TMP(1))
      call CombineAmpS(3,
     & (/5,9,7/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,8))
      CALL FFS3P1N_3(W(1,10), W(1,30), GC_76, TMP(1))
      call CombineAmpS(2,
     & (/1,3/), 
     & (/14,16/),
     & TMP, W, AMP(1,8))
      CALL FFS3P1N_3(W(1,11), W(1,29), GC_76, TMP(1))
      call CombineAmpS(2,
     & (/6,8/), 
     & (/14,16/),
     & TMP, W, AMP(1,8))
      CALL FFS3P1N_3(W(1,11), W(1,30), GC_76, TMP(1))
      call CombineAmpS(2,
     & (/2,4/), 
     & (/14,16/),
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV2_1(W(1,1),W(1,9),GC_91,MDL_MT,ZERO,W(1,31))  !  count 5
      CALL FFV2_1(W(1,2),W(1,9),GC_91,MDL_MT,ZERO,W(1,32))  !  count 4
      CALL FFS1_2P1N_3(W(1,10), W(1,31), GC_14, GC_10, TMP(1))
      call CombineAmpS(3,
     & (/5,9,7/), 
     & (/14,15,16/),
     & TMP, W, AMP(1,9))
      CALL FFS1_2P1N_3(W(1,10), W(1,32), GC_14, GC_10, TMP(1))
      call CombineAmpS(2,
     & (/1,3/), 
     & (/14,16/),
     & TMP, W, AMP(1,9))
      CALL FFS1_2P1N_3(W(1,11), W(1,31), GC_14, GC_10, TMP(1))
      call CombineAmpS(2,
     & (/6,8/), 
     & (/14,16/),
     & TMP, W, AMP(1,9))
      CALL FFS1_2P1N_3(W(1,11), W(1,32), GC_14, GC_10, TMP(1))
      call CombineAmpS(2,
     & (/2,4/), 
     & (/14,16/),
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV1P1N_3(W(1,10), W(1,29), GC_2, TMP(1))
      call CombineAmp(3,
     & (/5,9,7/), 
     & (/17,18,19/),
     & TMP, W, AMP(1,10))
      CALL FFV1P1N_3(W(1,10), W(1,30), GC_2, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/17,19/),
     & TMP, W, AMP(1,10))
      CALL FFV1P1N_3(W(1,11), W(1,29), GC_2, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/17,19/),
     & TMP, W, AMP(1,10))
      CALL FFV1P1N_3(W(1,11), W(1,30), GC_2, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/17,19/),
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV2_8P1N_3(W(1,10), W(1,29), GC_63, GC_68, TMP(1))
      call CombineAmp(3,
     & (/5,9,7/), 
     & (/20,21,22/),
     & TMP, W, AMP(1,11))
      CALL FFV2_8P1N_3(W(1,10), W(1,30), GC_63, GC_68, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/20,22/),
     & TMP, W, AMP(1,11))
      CALL FFV2_8P1N_3(W(1,11), W(1,29), GC_63, GC_68, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/20,22/),
     & TMP, W, AMP(1,11))
      CALL FFV2_8P1N_3(W(1,11), W(1,30), GC_63, GC_68, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/20,22/),
